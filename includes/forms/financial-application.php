...
function cardojo_financial_application( $shortcode_page ) { ?>
	...
	// Contact Car Dealer
	if( 'POST' == $_SERVER['REQUEST_METHOD'] AND ($_POST['cardojo_form_name'] == "financial_app" ) ) {

		if( isset( $_POST['FinanceApplicationForm_nonce'] ) && wp_verify_nonce( $_POST['FinanceApplicationForm_nonce'], 'FinanceApplicationForm_html' ) ){
			...
			$lead_cobuyer_email           = sanitize_email( $_POST['lead_cobuyer_email'] );
			...
			update_post_meta($td_post_id, 'lead_cobuyer_email', sanitize_email($_POST['lead_cobuyer_email']));
			...
			<table width="100%" border="0">
			  	<tr>
					<td colspan="2" style="font-size: 20px;font-weight:bold;color: #333;padding: 10px 0;">'.__('Financial Application', 'cardojo').'</td>
			  	</tr>
			  	<tr>
			  	...
			  	<tr>
					<td>'.__('Social Security Number', 'cardojo').'</td>
			  	...
			  	<tr>
					<td colspan="2" style="font-size: 16px;font-weight:bold;color: #333;padding: 10px 0;">'.__('Co-Buyer Personal Info', 'cardojo').'</td>
			  	</tr>
			  	<tr>
					<td>'.__('Name', 'cardojo').'</td>
			  	...
			  	<tr>
					<td>'.__('Time at Residence', 'cardojo').'</td>
			  	...
			  	<tr>
					<td colspan="2" style="font-size: 16px;font-weight:bold;color: #333;padding: 10px 0;">'.__('Co-Buyer Employment Info', 'cardojo').'</td>
			  	</tr>
			  	<tr>
					<td>'.__('Employer', 'cardojo').'</td>
			...
			$website_type = get_option("cardojo_webiste_type");
  			if( !empty($website_type) AND $website_type == "marketplace" ) {
  				$email = sanitize_email( $_POST['cardojo_dealer_email'] );
  			} else {
  				$email = get_option('admin_email');
  			}

		  	$subject = __('Financial Application Form from ', 'cardojo').$site_name;
	...
	<div id="cd-form-wrapp" class="cd-form-wrapp">
	    ...
	    <h4 class="heading"><?php esc_html_e('Financial Application', 'cardojo' ); ?></h4>

	    <?php } ?>

	    <?php if( get_cardojo_ssl_hide_forms() == "1" AND empty( $_SERVER['HTTPS'] ) ) { ?>

	    	<h5 class="cardojo-https-error"><?php esc_html_e('This page is not secure!', 'cardojo' ); ?><br><br><?php esc_html_e('Please contact the site administrator for more information.', 'cardojo' ); ?></h5>
	    ...
	    <?php } else { ?>
			...
			<h5 class="heading">
				...
				<?php esc_html_e('Your Finance Request has been sent.', 'cardojo' ); ?><br>
		    ...
		    <form id="submit-lead-cardojo-form" class="contact-form contact-form-application" action="<?php echo get_permalink(); ?>?form=finance#cardojo-contact-forms-holder" method="post">
		    	...
		    	<div class="options_group">
		    		...
		    		<fieldset>
				      	...
				      	<div class="cardojo-row">
							...
							<div class="cardojo-col-4">
								...
								<label for="lead_social_security" class="control-label"><i class="fa fa-lock" aria-hidden="true"></i> <?php esc_html_e('Social Security Number:', 'cardojo' ); ?></label>
								<input type="text" id="lead_social_security" name="lead_social_security" value="" placeholder="" />
					...
					<h5 class="cardojo-secure-info"><?php esc_html_e('* We secure and protect your confidential information', 'cardojo' ); ?></h5>
				...
				<div class="options_group">
		    		...
		    		<h2 class="options_group_heading"><?php esc_html_e('Co-Buyer Personal Info', 'cardojo' ); ?></h2>
		    		...
		    		<fieldset>
				      	...
				      	<div class="cardojo-row">
							...
							<div class="cardojo-col-4">
								...
								<label for="lead_cobuyer_first_name" class="control-label"><?php esc_html_e('First Name:', 'cardojo' ); ?></label>
								<input type="text" id="lead_cobuyer_first_name" name="lead_cobuyer_first_name" value="" placeholder="" />

							</div>

							<div class="cardojo-col-4">

								<label for="lead_cobuyer_middle_name" class="control-label"><?php esc_html_e('Middle Name:', 'cardojo' ); ?></label>
								<input type="text" id="lead_cobuyer_middle_name" name="lead_cobuyer_middle_name" value="" placeholder="" />

							</div>

							<div class="cardojo-col-4">

								<label for="lead_cobuyer_last_name" class="control-label"><?php esc_html_e('Last Name:', 'cardojo' ); ?></label>
								<input type="text" id="lead_cobuyer_last_name" name="lead_cobuyer_last_name" value="" placeholder="" />

							</div>

							<div class="cardojo-col-half">

								<label for="lead_cobuyer_address_1" class="control-label"><?php esc_html_e('Address 1:', 'cardojo' ); ?></label>
								<input type="text" id="lead_cobuyer_address_1" name="lead_cobuyer_address_1" value="" placeholder="" />

							</div>

							<div class="cardojo-col-half">

								<label for="lead_cobuyer_address_2" class="control-label"><?php esc_html_e('Address 2:', 'cardojo' ); ?></label>
								<input type="text" id="lead_cobuyer_address_2" name="lead_cobuyer_address_2" value="" placeholder="" />

							</div>

							<div class="cardojo-col-4">

								<label for="lead_cobuyer_city" class="control-label"><?php esc_html_e('City:', 'cardojo' ); ?></label>
								<input type="text" id="lead_cobuyer_city" name="lead_cobuyer_city" value="" placeholder="" />

							</div>

							<div class="cardojo-col-4">

								<label for="lead_cobuyer_state" class="control-label"><?php esc_html_e('State:', 'cardojo' ); ?></label>
								<input type="text" id="lead_cobuyer_state" name="lead_cobuyer_state" value="" placeholder="" />

							</div>

							<div class="cardojo-col-4">

								<label for="lead_cobuyer_zip" class="control-label"><?php esc_html_e('Zip:', 'cardojo' ); ?></label>
								<input type="text" id="lead_cobuyer_zip" name="lead_cobuyer_zip" value="" placeholder="" />

							</div>

							<div class="cardojo-col-4">

								<label for="lead_cobuyer_home_phone" class="control-label"><?php esc_html_e('Home Phone:', 'cardojo' ); ?></label>
								<input type="text" id="lead_cobuyer_home_phone" name="lead_cobuyer_home_phone" value="" placeholder="" />

							</div>

							<div class="cardojo-col-4">

								<label for="lead_cobuyer_mobile_phone" class="control-label"><?php esc_html_e('Mobile Phone:', 'cardojo' ); ?></label>
								<input type="text" id="lead_cobuyer_mobile_phone" name="lead_cobuyer_mobile_phone" value="" placeholder="" />

							</div>

							<div class="cardojo-col-4">

								<label for="lead_cobuyer_work_phone" class="control-label"><?php esc_html_e('Work Phone:', 'cardojo' ); ?></label>
								<input type="text" id="lead_cobuyer_work_phone" name="lead_cobuyer_work_phone" value="" placeholder="" />

							</div>

							<div class="cardojo-col-4">

								<label for="lead_cobuyer_time_at_address" class="control-label"><?php esc_html_e('Time At Residence:', 'cardojo' ); ?></label>
								<select name="lead_cobuyer_time_at_address" id="lead_cobuyer_time_at_address" class="form-control input-lg">
									<option value=""></option>
									<option value="0"><?php esc_html_e('0 Years', 'cardojo' ); ?></option>
									<option value="1"><?php esc_html_e('1 Year', 'cardojo' ); ?></option>
									<option value="2"><?php esc_html_e('2 Years', 'cardojo' ); ?></option>
							...
							<div class="cardojo-col-4">
								...
								<label for="lead_cobuyer_residence_type" class="control-label"><?php esc_html_e('Residence Type:', 'cardojo' ); ?></label>
								<select name="lead_cobuyer_residence_type" id="lead_cobuyer_residence_type" class="form-control input-lg">
									<option value=""></option>
									<option value="Rent" ><?php esc_html_e('Rent', 'cardojo' ); ?></option>
									<option value="Own" ><?php esc_html_e('Own', 'cardojo' ); ?></option>
							...
							<div class="cardojo-col-4">
								...
								<label for="lead_cobuyer_residence_price" class="control-label"><?php esc_html_e('Rent/Mortgage:', 'cardojo' ); ?> (<?php $cardojo_currency = get_option( 'cardojo_currency' ); if(!empty($cardojo_currency)) { echo esc_html_e('in', 'cardojo' ); echo " "; echo $cardojo_currency; } ?>)</label>
								<input type="text" id="lead_cobuyer_residence_price" name="lead_cobuyer_residence_price" value="" placeholder="" />

							</div>

							<div class="cardojo-col-4">

								<label for="lead_cobuyer_email" class="control-label"><?php esc_html_e('Email Address:', 'cardojo' ); ?></label>
								<input type="text" id="lead_cobuyer_email" name="lead_cobuyer_email" value="" placeholder="" />

							</div>

							<div class="cardojo-col-4">

								<label for="lead_cobuyer_birth_date" class="control-label"><?php esc_html_e('Date of Birth:', 'cardojo' ); ?></label>

								<div class="cardojo-input-has-icon">
									<input class="date_picker_past cardojo-input-icon-left" type="text" id="lead_cobuyer_birth_date" name="lead_cobuyer_birth_date" placeholder="<?php esc_html_e('Select Date', 'cardojo' ); ?>" value="" />
									<span class="fa fa-calendar cardojo-input-icon left" aria-hidden="true"></span>
								</div>
							...
							<div class="cardojo-col-4">
								...
								<label for="lead_cobuyer_social_security" class="control-label"><i class="fa fa-lock" aria-hidden="true"></i> <?php esc_html_e('Social Security Number:', 'cardojo' ); ?></label>
								<input type="text" id="lead_cobuyer_social_security" name="lead_cobuyer_social_security" value="" placeholder="" />
				...
				<div class="options_group">
					...
					<h2 class="options_group_heading"><?php esc_html_e('Co-Buyer Employment Info', 'cardojo' ); ?></h2>

					<fieldset>
							
						<div class="cardojo-row">

							<div id="buyer_employer" class="lead_cobuyer_buyer_employers active">

								<div class="cardojo-col-half">

									<label for="employer_cobuyer_name" class="control-label"><?php esc_html_e('Employer:', 'cardojo' ); ?></label>
									<input type="text" id="employer_cobuyer_name" name="employer_cobuyer_name" value="" placeholder="" />

								</div>

								<div class="cardojo-col-half">

									<label for="employer_cobuyer_income" class="control-label"><?php esc_html_e('Monthly Income:', 'cardojo' ); ?> (<?php $cardojo_currency = get_option( 'cardojo_currency' ); if(!empty($cardojo_currency)) { echo esc_html_e('in', 'cardojo' ); echo " "; echo $cardojo_currency; } ?>)</label>
									<input type="text" id="employer_cobuyer_income" name="employer_cobuyer_income" value="" placeholder="" />

								</div>

								<div class="cardojo-col-half">

									<label for="employer_cobuyer_occupation" class="control-label"><?php esc_html_e('Occupation:', 'cardojo' ); ?></label>
									<input type="text" id="employer_cobuyer_occupation" name="employer_cobuyer_occupation" value="" placeholder="" />

								</div>

								<div class="cardojo-col-half">

									<label for="employer_cobuyer_address_1" class="control-label"><?php esc_html_e('Address 1:', 'cardojo' ); ?></label>
									<input type="text" id="employer_cobuyer_address_1" name="employer_cobuyer_address_1" value="" placeholder="" />

								</div>

								<div class="cardojo-col-half">

									<label for="employer_cobuyer_address_2" class="control-label"><?php esc_html_e('Address 2:', 'cardojo' ); ?></label>
									<input type="text" id="employer_cobuyer_address_2" name="employer_cobuyer_address_2" value="" placeholder="" />

								</div>

								<div class="cardojo-col-half">

									<label for="employer_cobuyer_city" class="control-label"><?php esc_html_e('City:', 'cardojo' ); ?></label>
									<input type="text" id="employer_cobuyer_city" name="employer_cobuyer_city" value="" placeholder="" />

								</div>

								<div class="cardojo-col-half">

									<label for="employer_cobuyer_state" class="control-label"><?php esc_html_e('State:', 'cardojo' ); ?></label>
									<input type="text" id="employer_cobuyer_state" name="employer_cobuyer_state" value="" placeholder="" />

								</div>

								<div class="cardojo-col-half">

									<label for="employer_cobuyer_zip" class="control-label"><?php esc_html_e('Zip:', 'cardojo' ); ?></label>
									<input type="text" id="employer_cobuyer_zip" name="employer_cobuyer_zip" value="" placeholder="" />

								</div>

								<div class="cardojo-col-12">

									<label for="employer_cobuyer_phone" class="control-label"><?php esc_html_e('Phone Number:', 'cardojo' ); ?></label>
									<input type="text" id="employer_cobuyer_phone" name="employer_cobuyer_phone" value="" placeholder="" />
								...
								<div class="cardojo-col-half">
									...
									<label for="employer_cobuyer_years" class="control-label"><?php esc_html_e('Years:', 'cardojo' ); ?></label>
									<select name="employer_cobuyer_years" id="employer_cobuyer_years" class="form-control input-lg">
										<option value=""></option>
										<option value="0" ><?php esc_html_e('0 Years', 'cardojo' ); ?></option>
										<option value="1" ><?php esc_html_e('1 Year', 'cardojo' ); ?></option>
										<option value="2" ><?php esc_html_e('2 Years', 'cardojo' ); ?></option>
								...
								<div class="cardojo-col-half">
									...
									<label for="employer_cobuyer_months" class="control-label"><?php esc_html_e('Months:', 'cardojo' ); ?></label>
									<select name="employer_cobuyer_months" id="employer_cobuyer_months" class="form-control input-lg">
										<option value=""></option>
										<option value="0" ><?php esc_html_e('0 Months', 'cardojo' ); ?></option>
										<option value="1" ><?php esc_html_e('1 Month', 'cardojo' ); ?></option>
										<option value="2" ><?php esc_html_e('2 Months', 'cardojo' ); ?></option>
				...
				<?php $finance_disclaimer = get_option("cardojo_finance_disclaimer"); if(!empty($finance_disclaimer)) { ?>

				<div class="options_group">

					<h2 class="options_group_heading"><?php esc_html_e('* TERMS AND DISCLOSURE', 'cardojo' ); ?></h2>
					...
					<fieldset>
						...
						<div class="cardojo-row">
							...
							<div class="cardojo-col-12">
								...
								<p><?php echo wp_kses($finance_disclaimer, true); ?></p>
				...
				<?php } ?>
				<input type="hidden" name="cardojo_form_name" value="financial_app" />
				...
				<input type="hidden" name="action" value="FinanceApplicationForm" />
				<?php wp_nonce_field( 'FinanceApplicationForm_html', 'FinanceApplicationForm_nonce' ); ?>

				<a id="cardojo_submit_application" href="#" class="btn btn-default"><i class="fa fa-spinner fa-spin fa-3x fa-fw"></i> <?php esc_html_e( 'Submit Application', 'cardojo' ) ?></a>
