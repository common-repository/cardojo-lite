<?php
    ...
    if( $action == "duplicate" OR $action == "edit" ) {
	    ...
	    if ( ! cardojo_user_can_edit_car( $car_id ) ) {
	    	...
	    	echo "<div class='car-manager-error'>" . __( 'Invalid ID', 'cardojo' ) . "</div>";

	    } else {

	    	cardojo_load_submit_form( $car_id );
...
<?php function cardojo_load_submit_form( $car_id ) { ?>

<div id="cardojo-submit">
	...
	<?php
        ...
        if(!empty($car_id)) {
			...
			$vehicle_doors = esc_attr(get_post_meta($car_id, 'vehicle_doors',true));
			$vehicle_seats = esc_attr(get_post_meta($car_id, 'vehicle_seats',true));

			$vehicle_description = wp_kses(get_post_meta($car_id, 'vehicle_description', true), true);
			...
			$vehicle_cheaper_car_exg = esc_attr(get_post_meta($car_id, 'vehicle_cheaper_car_exg',true));
			$vehicle_expensive_car_exg = esc_attr(get_post_meta($car_id, 'vehicle_expensive_car_exg',true));
			$vehicle_negociable_price = esc_attr(get_post_meta($car_id, 'vehicle_negociable_price',true));
	...
	<form action="<?php echo get_permalink(); ?>?action=edit&car_id=<?php echo esc_attr($car_id); ?>" method="post" id="submit-cardojo-form" class="cardojo-form" enctype="multipart/form-data">
		...
		<div class="options_group">
			...
			<h2 class="options_group_heading"><?php esc_html_e('Car Info', 'cardojo' ); ?></h2>
		...
		<div class="options_group">
			...
			<h2 class="options_group_heading"><?php esc_html_e('Condition', 'cardojo' ); ?></h2>
		...
		<div class="options_group">
			...
			<h2 class="options_group_heading"><?php esc_html_e('Characteristics', 'cardojo' ); ?></h2>
		...
		<div class="options_group">
			...
			<h2 class="options_group_heading"><?php esc_html_e('Description', 'cardojo' ); ?></h2>
		...
		<div class="options_group">
			...
			<h2 class="options_group_heading"><?php esc_html_e('Engine and Transmission', 'cardojo' ); ?></h2>
		...
		<div class="options_group">
			...
			<h2 class="options_group_heading"><?php esc_html_e('Fuel consumption and emissions', 'cardojo' ); ?></h2>
		...
		<div class="options_group">
			...
			<h2 class="options_group_heading"><?php esc_html_e('Dimenions and weight', 'cardojo' ); ?></h2>
		...
		<div class="options_group">
			...
			<h2 class="options_group_heading"><?php esc_html_e('Vehicle features and specifications', 'cardojo' ); ?></h2>
										...
										<?php
											...
											if(!empty($categories_child)) {
												...
												<select class="taxonomy-subcategory-select" name="vehicle_comfort[]">
													...
													<option value="na" <?php if( !has_term( $category->term_id, 'vehicle_comfort', $car_id ) ) { echo "selected"; } ?>><?php esc_html_e('Select', 'cardojo' ); ?> - <?php echo $category->cat_name; ?></option>
										...
										<?php
											...
											if(!empty($categories_child)) {
												...
												<select class="taxonomy-subcategory-select" name="vehicle_visibility[]">
													...
													<option value="na" <?php if( !has_term( $category->term_id, 'vehicle_visibility', $car_id ) ) { echo "selected"; } ?>><?php esc_html_e('Select', 'cardojo' ); ?> - <?php echo $category->cat_name; ?></option>
										...
										<?php
											...
											if(!empty($categories_child)) {
												...
												<select class="taxonomy-subcategory-select" name="vehicle_exterior[]">
													...
													<option value="na" <?php if( !has_term( $category->term_id, 'vehicle_exterior', $car_id ) ) { echo "selected"; } ?>><?php esc_html_e('Select', 'cardojo' ); ?> - <?php echo $category->cat_name; ?></option>
										...
										<?php
											...
											if(!empty($categories_child)) {
												...
												<select class="taxonomy-subcategory-select" name="vehicle_interior[]">
													...
													<option value="na" <?php if( !has_term( $category->term_id, 'vehicle_interior', $car_id ) ) { echo "selected"; } ?>><?php esc_html_e('Select', 'cardojo' ); ?> - <?php echo $category->cat_name; ?></option>
		...
		<div class="options_group">
			...
			<h2 class="options_group_heading"><?php esc_html_e('Location & contact info', 'cardojo' ); ?></h2>
		...
		<div class="options_group">
			...
			<h2 class="options_group_heading"><?php esc_html_e('Price', 'cardojo' ); ?></h2>
		...
		<div class="options_group">
			...
			<h2 class="options_group_heading"><?php esc_html_e('Photo Gallery', 'cardojo' ); ?></h2>
			...
			<fieldset>
				...
				<div class="cardojo-row">
					...
					<div id="vehicle_gallery_more_images">
						...
						<div class="col-md-3 col-sm-6" data-id="<?php echo esc_attr($i); ?>">
						...
						<div class="col-md-3 col-sm-6" data-id="<?php $totalImg = count($vehicle_image_extended_gallery); $totalImg++; echo esc_attr($totalImg); ?>">
		...
		<div id="car_expenses">
			...
			<div class="options_group">
				...
				<h2 class="options_group_heading"><?php esc_html_e('Expenses', 'cardojo' ); ?></h2>
				...
				<fieldset class="cardojo-last-fieldset">
					...
					<div class="cardojo-row">
						...
						<div class="cardojo-col-12">
							...
							<a id="cardojo_submit_vehicle" href="#" class="btn btn-default"><?php esc_html_e( 'Save vehicle', 'cardojo' ) ?></a>

							<a id="cardojo_discard_vehicle" href="<?php echo esc_url(cardojo_get_permalink( 'inventory' )); ?>" class="btn btn-default"><?php esc_html_e( 'Cancel', 'cardojo' ) ?></a>
